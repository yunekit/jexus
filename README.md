...
**Jexus 性能强劲、功能全面、应用场景广泛、服务便捷周到。**

*\* 如果你希望拥有一款纯粹的国产 WEB 服务器精品用于替代 Nginx、Apache 等外国产品，不管从安全角度还是从低成本角度看，不管是从性能角度还是从功能角度看，Jexus都无疑是你最好的选择 。*

Jexus 作者的联系邮箱：j66x@163.com，QQ号：273766940.

----

🔗&emsp;[Jexus 官方网站](https://www.jexus.org) &emsp;[用户手册 v7.x](docs/manual.md) &emsp;[用户手册 v8.x](docs/manual_v8.md) &emsp;[GitHub](https://github.com/yunekit/jexus) &emsp;[Gitee](https://gitee.com/yunekit/jexus)
